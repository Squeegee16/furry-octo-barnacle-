...
from flaskinventory.main.utils import stripper,save_picture, cal_space, create_p2, planting_interval,growth_status,db_convert,getfrosty,montoint,getastrodata,str2bool,update_sorter
...
def move():
    ...
    if form.validate_on_submit() and request.method == 'POST' :
        print(form.src.data,form.destination.data,form.mprodname.data,form.mprodvar.data,form.mprodqty.data)
...
def locstatCard():
    ...
    if request.method == 'GET':
        if dat == None:
            ...
            gs = growth_status(dat.planted_date,plt.DTMat,plt.germination)    
